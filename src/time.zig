// Copyright nektro MIT (https://github.com/nektro/zig-time/blob/master/licenses.txt)
// https://github.com/nektro/zig-time/blob/master/time.zig
//
// TODO: this has been copied as the repository doesn't support the Zig package manager.
